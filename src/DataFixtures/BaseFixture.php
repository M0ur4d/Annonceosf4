...
abstract class BaseFixture extends Fixture{
    ...
    /**
     * getRamdomReference : pour recuperer aleatoirement une référence
     */
    protected function getRandomReference(string $groupName){
        ...
        if(empty($this->referencesIndex[$groupName])) {
            throw new \Exception(sprintf("Ne peut trouver de reference pour le groupe '%s'", $groupName));
        }

        // Retourne une reference aleatoire
